...
pkgdatadir = $(datadir)/numberplacegenerator
pkgincludedir = $(includedir)/numberplacegenerator
pkglibdir = $(libdir)/numberplacegenerator
pkglibexecdir = $(libexecdir)/numberplacegenerator
...
DX_DVIPS = 
DX_EGREP = 
DX_ENV =  SRCDIR='.' PROJECT='NumberPlaceGenerator' DOCDIR='doxygen-doc' VERSION='1.1.1' PERL_PATH='/opt/local/bin/perl' HAVE_DOT='NO' GENERATE_MAN='NO' GENERATE_RTF='NO' GENERATE_XML='NO' GENERATE_HTMLHELP='NO' GENERATE_CHI='NO' GENERATE_HTML='YES' GENERATE_LATEX='NO'
DX_FLAG_chi = 0
DX_FLAG_chm = 0
DX_FLAG_doc = 1
DX_FLAG_dot = 0
...
DX_PROJECT = NumberPlaceGenerator
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
PACKAGE_STRING = NumberPlaceGenerator 1.1.1
...
##DX_CLEAN_CHI = doxygen-doc/numberplacegenerator.chi
#DX_CLEAN_MAN = doxygen-doc/man
#DX_CLEAN_RTF = doxygen-doc/rtf
#DX_CLEAN_XML = doxygen-doc/xml
#DX_CLEAN_PS = doxygen-doc/numberplacegenerator.ps
#DX_PS_GOAL = doxygen-ps
#DX_CLEAN_PDF = doxygen-doc/numberplacegenerator.pdf
#DX_PDF_GOAL = doxygen-pdf
#DX_CLEAN_LATEX = doxygen-doc/latex
DX_CLEANFILES = \
    doxygen-doc/numberplacegenerator.tag \
    -r \
    $(DX_CLEAN_HTML) \
    $(DX_CLEAN_CHM) \
    $(DX_CLEAN_CHI) \
...
EXTRA_DIST = $(DX_CONFIG) README.md mainpage.txt
...
#doxygen-ps: doxygen-doc/numberplacegenerator.ps

#doxygen-doc/numberplacegenerator.ps: doxygen-doc/numberplacegenerator.tag
...
#	done; \
#	$(DX_DVIPS) -o ../numberplacegenerator.ps refman.dvi

#doxygen-pdf: doxygen-doc/numberplacegenerator.pdf

#doxygen-doc/numberplacegenerator.pdf: doxygen-doc/numberplacegenerator.tag
#	cd doxygen-doc/latex; \
#	rm -f *.aux *.toc *.idx *.ind *.ilg *.log *.out; \
...
#	    countdown=`expr $$countdown - 1`; \
#	done; \
#	mv refman.pdf ../numberplacegenerator.pdf

.PHONY: doxygen-run doxygen-doc $(DX_PS_GOAL) $(DX_PDF_GOAL)

.INTERMEDIATE: doxygen-run $(DX_PS_GOAL) $(DX_PDF_GOAL)

doxygen-run: doxygen-doc/numberplacegenerator.tag

doxygen-doc: doxygen-run $(DX_PS_GOAL) $(DX_PDF_GOAL)

doxygen-doc/numberplacegenerator.tag: $(DX_CONFIG) $(pkginclude_HEADERS)
	rm -rf doxygen-doc
